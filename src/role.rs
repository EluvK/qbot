...
static CLIPPY_SYSTEM_INFO: &str = "I need you to behave like rust-clippy. For every piece of code I send you, keep the original logic, but try to make it more concise and elegant.";
...
impl BotRole {
    ...
    pub fn system_infomation(&self) -> Vec<GPTMessages> {
        match self {
            ...
            BotRole::Clippy => vec![GPTMessages::new_system_message(CLIPPY_SYSTEM_INFO.into())],
        }
    }
}
